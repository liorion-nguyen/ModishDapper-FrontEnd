    ...
    const products = [
        {
            ...
            quantity: 1,
            price: 999000,
            image: 'https://down-vn.img.susercontent.com/file/vn-11134201-7qukw-lhd4cxpgxipfcd'
        },
        {
            ...
            quantity: 2,
            price: 100000,
            image: 'https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lfzme3skayju1a'
        },
    ]
                                        ...
                                        <StyleBoxContentProduct item xs={6}>
                                            ...
                                            <StyleParaProduct>
                                                <StyleBoxParaProduct>
                                                    ...
                                                    <StyleContebtParaProduct>{product.color}</StyleContebtParaProduct>
                                                </StyleBoxParaProduct>
                                                <StyleBoxParaProduct>
                                                    <StyleTextParaProduct>Kích cỡ:</StyleTextParaProduct>
                                                    <StyleContebtParaProduct>{product.size}</StyleContebtParaProduct>
                                                </StyleBoxParaProduct>
                                                <StyleBoxParaProduct>
                                                    <StyleTextParaProduct>Số lượng:</StyleTextParaProduct>
                                                    <StyleContebtParaProduct>{product.quantity}</StyleContebtParaProduct>
                                                </StyleBoxParaProduct>
                                            </StyleParaProduct>
                ...
                <StyleGridPrice item xs={3.5}>
                    <StyleBoxTopPrice>
                        ...
                        <StyleFormCodePrice method="post">
                            <StyleInputCodePrice type='text' placeholder="Nhập mã khuyến mại" />
                            <StyleIconNextPrice />
                        </StyleFormCodePrice>
                    </StyleBoxTopPrice>
                    <StyleBoxBottomPrice>
                        ...
                        <StyleContactPrice>
                            <StyleBoxSpaceBetween>
                                ...
                                <StyleTextBoldPrice>{handlePriceProduct()} VNĐ</StyleTextBoldPrice>
                            </StyleBoxSpaceBetween>
                            <StyleBoxSpaceBetween>
    ...
    return (
        <Box>
            ...
            <StyleFormTransport method='post'>
                ...
                <StylePRegular16>Hãy thử trước khi mua. Thời gian giao hàng 2-7 ngày</StylePRegular16>
                <StylePBold16>Đơn hàng nên được giao ở đâu?</StylePBold16>
                <StylePRegular16>Nhập địa chỉ trên bản đồ hoặc sử dụng tìm kiếm</StylePRegular16>
                <StyleBoxLocation>
                    <Location />
