                        ...
                        topSearches.map((item, index) => (
                            <StyleBoxTop href={item.href} key={index}>
                                <StyleBoxImgTop>
                                    ...
                                    <StyleEleInImgTop>
                                        <StyleNumberDiscountTop className={item.discount === 0 ? "hidden" : ""}>-{item.discount}%</StyleNumberDiscountTop>
                                        <StyleBoxIconTop>
                                ...
                                <StyleBoxContentTop>
                                    ...
                                    <StyleBoxPriceTop>
                                        <StylePPriceTop className={item.discount > 0 ? "txt-line" : ""}>{item.price}VNĐ</StylePPriceTop>
                                        {
                                            item.discount > 0 && <StylePPriceTop>{parseFloat((item.price - (item.discount * item.price * 0.01)).toFixed(2))}VNĐ</StylePPriceTop>
                                        }
                                    </StyleBoxPriceTop>
                                </StyleBoxContentTop>
                            </StyleBoxTop>
        ...
        <Slider {...settings} className="slide">
            {
                slide.map((item, index) => (
                    <StyleASlide href={item.href} key={index}><StyleImgInBox src={item.img} /></StyleASlide>
                ))
            }
        </Slider>
    );
...
export function ModishDapper() {
    const pictures = ['https://down-vn.img.susercontent.com/file/29cc1084e769b71fa7e0ffb76923c712', 'https://down-vn.img.susercontent.com/file/e8d892dd18605059d8779b3429089535', 'https://down-vn.img.susercontent.com/file/fb806c82c1b0a06b9ce05fe238976a9f', 'https://down-vn.img.susercontent.com/file/cn-11134207-7qukw-lk9bwlyoru7q8a', 'https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lgwkierhueb702', 'https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lgwkieripanm41', 'https://down-vn.img.susercontent.com/file/vn-11134201-23020-dzu5e2xe8invd4', 'https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lh4nfbozlblfdc']
    return (
        <StyleBoxDeal>
